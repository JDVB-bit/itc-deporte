...
class ServicioDeCuadroFinal:
    ...
    def generar(
        ...
        self._persistir(fase_id, bracket)
        return bracket
    ...
    def _persistir(self, fase_id: FaseId, bracket: Bracket) -> None:
        partidos = [
            _a_enfrentamiento(fase_id, casilla)
...
def _a_enfrentamiento(fase_id: FaseId, casilla: SlotDeBracket) -> Enfrentamiento:
